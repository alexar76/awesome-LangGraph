...
| Project | Description | GitHub Stars |
|---|---|---|
| [cacheplane/angular-agent-framework](https://github.com/cacheplane/angular-agent-framework) | Angular-native chat, durable threads, interrupts, subagents, planning, memory, and generative UI for LangGraph (and AG-UI) agents | ![GitHub stars](https://img.shields.io/github/stars/cacheplane/angular-agent-framework?style=social)<br>![Last commit](https://img.shields.io/github/last-commit/cacheplane/angular-agent-framework) |
...
| [tam159/next-role](https://github.com/tam159/next-role) | GenAI career assistant: a supervisor agent turns your CV + a job description into a tailored resume PDF, interview-prep doc, and day-of battlecard; runs as an MCP server and A2A endpoint | ![GitHub stars](https://img.shields.io/github/stars/tam159/next-role?style=social)<br>![Last commit](https://img.shields.io/github/last-commit/tam159/next-role) |
